...
def visualize_model_comparison(results):
    ...
    axes[0,0].bar(x - width, r2_scores, width, label='R²', alpha=0.8)
    ...
    axes[0,0].set_ylabel('Performance Metrics')
...
## 🎯 Executive Summary
- **Dataset**: {len(results)} models trained on enhanced yacht market data
...
"""
    ...
    print(f"\n✅ ML Performance Report generated: 'yacht_ml_performance_report.md'")
...
def main():
    ...
    # Train models
    print("🤖 Training ML models (RandomForest, GradientBoosting, LinearRegression)...")
